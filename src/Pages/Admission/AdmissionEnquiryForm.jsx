...
const AdmissionEnquiryForm = () => {
  ...
  const mobileOperators = {
    // Jio
    '70': 'Jio', '72': 'Jio', '73': 'Jio', '74': 'Jio', '75': 'Jio',
    '76': 'Jio', '77': 'Jio', '78': 'Jio', '79': 'Jio',
    
    // Airtel
    '98': 'Airtel', '99': 'Airtel', '96': 'Airtel', '97': 'Airtel',
    '81': 'Airtel', '82': 'Airtel', '83': 'Airtel', '84': 'Airtel',
    '85': 'Airtel', '86': 'Airtel', '88': 'Airtel', '89': 'Airtel',
    
    // Vodafone Idea
    '90': 'Vodafone Idea', '91': 'Vodafone Idea', '92': 'Vodafone Idea',
    '93': 'Vodafone Idea', '94': 'Vodafone Idea', '95': 'Vodafone Idea',
    ...
    // MTNL
    '87': 'MTNL', '88': 'MTNL', '89': 'MTNL',
    
    // Reliance Communications
    '60': 'Reliance', '61': 'Reliance', '62': 'Reliance', '63': 'Reliance',
    '64': 'Reliance', '65': 'Reliance', '66': 'Reliance', '67': 'Reliance',
    '68': 'Reliance', '69': 'Reliance',
    
    // Tata Docomo
    '50': 'Tata Docomo', '51': 'Tata Docomo', '52': 'Tata Docomo',
    '53': 'Tata Docomo', '54': 'Tata Docomo', '55': 'Tata Docomo',
    '56': 'Tata Docomo', '57': 'Tata Docomo', '58': 'Tata Docomo',
    '59': 'Tata Docomo',
  };
  ...
  }, [showEnquiries, currentPage, perPage, searchTerm, statusFilter, classFilter]);
  ...
  const renderFormField = (fieldConfig) => {
    ...
    return (
      <div className="mb-6">
        ...
        {name === "mobile_no" && !error && value.length === 10 && mobileValidation.isValid && (
          <div className="mt-1">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="bg-gray-50">
                          ...
                          <th className="py-3 px-4 text-left text-sm font-semibold text-gray-700">Father</th>
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {enquiries.map((enquiry) => (
                          <tr key={enquiry.id} className="hover:bg-gray-50">
                            <td className="py-3 px-4 text-sm text-gray-600">#{enquiry.id}</td>
                            ...
                            <td className="py-3 px-4 text-sm text-gray-600">{enquiry.father_name}</td>
                            <td className="py-3 px-4">
                            ...
                            <td className="py-3 px-4">
                              <span className={`inline-block px-3 py-1 text-xs font-medium rounded-full ${getStatusColor(enquiry.status)}`}>
              ...
              {(Object.keys(errors).length > 0 || submitError) && (
                <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <ul className="list-disc list-inside text-red-700 text-sm space-y-1">
                    ...
                    {errors.date_of_birth && <li>Date of Birth: {errors.date_of_birth}</li>}
                    {errors.admission_class && <li>Admission Class: {errors.admission_class}</li>}
                    {errors.last_exam && <li>Last Exam: {errors.last_exam}</li>}
                    {errors.father_name && <li>Father's Name: {errors.father_name}</li>}
                    {errors.email && <li>Email: {errors.email}</li>}
                    {errors.mobile_no && <li>Mobile Number: {errors.mobile_no}</li>}
